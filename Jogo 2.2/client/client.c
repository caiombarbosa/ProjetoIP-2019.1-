...
/////////////////////////////////////////   VARIAVEIS DA MAIN PARA O JOGO   ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    ///Camera 
        ...
        int pos_x_sprite = players[0].posxInicial, pos_y_sprite = players[0].posyInicial;
        
        int pos_x_camera = players[0].posxInicial, pos_y_camera = players[0].posyInicial;
    ...
    //----------------------------------------------------//  SECÃO DE MOVIMENTACAO E MAGIAS //----------------------------------------------//
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                ...
                if (cont_frames >= frames_sprite){
                    ret = sendMsgToServer(&players[0], sizeof(Jogador));
                    if(ret == SERVER_DISCONNECTED){
                        sair = true;
                    }
                    //reseta cont_frames
...
//--------------------------------------------//////////// --* MAGIA DE FOGO (Z) //////////////------------------------------------------------------------------------------//
    ...
    //--------------------------------------------//////////// *-- MAGIA DE GELO (X) ////////////////--------------------------------------------/////
                ...
                players[0].posX = pos_x_sprite;
                players[0].posY = pos_y_sprite;
