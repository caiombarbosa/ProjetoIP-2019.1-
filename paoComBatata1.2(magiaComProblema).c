// para compilar   gcc joguin.c -o joguin -lallegro -lallegro_ttf -lallegro_image -lallegro_font -lallegro_dialog
    ...
    int inicializar(){
        ...
        magia_Z = al_load_bitmap("fogo.png");
        if (!magia_Z){
        ...
        al_convert_mask_to_alpha(magia_Z,al_map_rgb(255,0,255));
        //carrega o fundo
    ...
    int main(void){
        ...
        int pos_x_magia = 0, pos_y_magia = 0;
        char magiaPos;
        ...
        while(!sair){
            ...
            if(desenha && al_is_event_queue_empty(fila_eventos)) {
                ...
                if(tecla==5){
                    //Se o personagem estiver para cima printa a magia pra cima
                    switch(magiaPos){
                        case 'c':
                            pos_y_magia = pos_y_sprite + 100;
                            pos_x_magia = pos_x_sprite;
                            break;
                    //Se o personagem estiver para baixo printa a magia pra baixo
                        case 'b':
                            pos_y_magia = pos_y_sprite - 80;
                            pos_x_magia = pos_x_sprite;
                            break;
                    //Se o personagem estiver para direita printa a magia pra direita
                        case 'd':
                            pos_x_magia = pos_x_sprite + 100;
                            pos_y_magia = pos_y_sprite;
                            break;
                    //Se o personagem estiver para esquerda printa a magia pra esquerda
                        case 'e':
                            pos_x_magia = pos_x_sprite - 80;
                            pos_y_magia = pos_y_sprite;
                            break;
                    }
                   
                   while(linha_atual_magia!=linha_folha_magia){
                            linha_atual_magia++; 
                            coluna_atual_magia++;
