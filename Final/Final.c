// para compilar : gcc menu.c -o joguin -lallegro -lallegro_ttf -lallegro_image -lallegro_font -lallegro_dialog -lallegro_primitives -lallegro_acodec -lallegro_audio
...
bool loadBitmaps(){
    ...
    game_mode = al_load_bitmap("guide.jpg");
