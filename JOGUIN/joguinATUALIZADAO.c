...
//////////////////////////////////////////////////////////////////////////////// *-- DEFININDO OS TAMANHOS DE CADA SPRITE --*//////////////////////////////////////////////////////////////////////
    ...
    ///*--SPRITES DE PERSONAGENS--*///
     ...
     ///---* SPRITES DE MAGIA --*//////
        int altura_magia_Z = 128, largura_magia_Z = 128;
        // posicao da magia
        int pos_x_magiaZ = 0, pos_y_magiaZ = 0;
        // qt de linhas com magias
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //----------------------------------------------------//  SECÃO DE MOVIMENTACAO E MAGIAS //----------------------------------------------//
        ...
        ////////////////////////////////////////////////* -- DESENHANDO AS MAGIAS QUE FORAM USADA --*///////////////////////////////////////////////////////////////////////////
                   ...
                   //VOU DESENHAR A MAGIA DE FOGO adequando ela para a pos do personagem
                   switch (magiaPos)
                   {
                       case 'C':
                            // magia para cima
                            pos_x_magiaZ = pos_x_sprite;
                            pos_y_magiaZ = pos_y_sprite + 80;
                            for(i = 0; i<10; i++){
                                al_draw_bitmap_region(folha_sprite,
                                regiao_x_magia_Z,regiao_y_magia_Z+(128*i),
                                largura_magia_Z,altura_magia_Z,
                                pos_x_magiaZ,pos_y_magiaZ,0);
                            }
                            tecla = 0;
                            break;
                       case 'B':
                       ...
                       case 'D':
                            // magia para direita
                            pos_x_magiaZ = pos_x_sprite + 80;
                            pos_y_magiaZ = pos_y_sprite;
                            for(i = 0; i<10; i++){
                                al_draw_bitmap_region(folha_sprite,
                                regiao_x_magia_Z,regiao_y_magia_Z+(128*i),
                                largura_magia_Z,altura_magia_Z,
