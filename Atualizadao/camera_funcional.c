// para compilar gcc joguin.c -o joguin -lallegro -lallegro_ttf -lallegro_image -lallegro_font -lallegro_dialog
 ...
 ALLEGRO_BITMAP *folha_sprite_Erick = NULL;
 ALLEGRO_BITMAP *folha_sprite_Erick_Batalha = NULL;
...
///////////////////////////////// *-- SṔRITES DE PERSONAGENS --* /////////////////////////////////////////////////////
 ...
 folha_sprite_Erick = al_load_bitmap("ericandando.png");
 if (!folha_sprite_Erick){
 error_msg("Falha ao carregar sprites");
 al_destroy_timer(timer);
 al_destroy_display(janela);
 al_destroy_event_queue(fila_eventos);
 ...
 folha_sprite_Erick_Batalha = al_load_bitmap("ericemposedebatalha.png");
 if (!folha_sprite_Erick_Batalha){
 error_msg("Falha ao carregar sprites");
 al_destroy_timer(timer);
 al_destroy_display(janela);
 al_destroy_event_queue(fila_eventos);
...
//////////////////////////////////////////////////////////////////////////////////////////////////////* -- ATUALIZA TELA -- *///////////////////////////////////////////////////////////////////////////////
 ...
 printf("\nCamera X: %d ",cameraX);
 printf("\nCamera Y: %d ",cameraY);
 printf("\nJogador X: %d",pos_x_sprite);
 printf("\nJogador Y: %d",pos_y_sprite);
...
//--------------------------------------------///////// --* MAGIA DE RAIO (C) ///////////////--------------------------------------------/////
 ...
 regiao_x_magia_C+((cooldown-1)*64),regiao_y_magia_C,
